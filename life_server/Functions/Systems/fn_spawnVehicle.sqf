...
diag_log "------------- Client VehicleQuery Request -------------";
...
{
	[[_vehicle,"cop_suv",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};

if((_vInfo select 1) == "cop" && (_vInfo select 2) == "B_MRAP_01_F") then
{
	[[_vehicle,"cop_hunter",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};

if((_vInfo select 1) == "cop" && (_vInfo select 2) == "B_MRAP_01_hmg_F") then
{
	[[_vehicle,"cop_hunterhmg",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};

if((_vInfo select 1) == "cop" && (_vInfo select 2) == "I_MRAP_03_F") then
{
	[[_vehicle,"cop_strider",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};
...
{
	[[_vehicle,"med_suv",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};

if((_vInfo select 1) == "med" && (_vInfo select 2) == "B_Heli_Light_01_F") then
{
	[[_vehicle,"med_littlebird",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};
