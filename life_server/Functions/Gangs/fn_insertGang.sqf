...
if(count _queryResult != 0) exitWith {
	[[1,"Dieser Gangname ist bereits vergeben."],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP;
...
if(count _queryResult != 0) exitWith {
	[[1,"Du bist schon in einer Gang. Verlasse diese erst."],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP;
	[["life_action_gangInUse",nil,missionNamespace],"life_fnc_netSetVar",_ownerID,false] spawn life_fnc_MP;
};
