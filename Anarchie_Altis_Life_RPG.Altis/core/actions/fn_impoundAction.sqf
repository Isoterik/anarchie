...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	if(getDammage _vehicle > 0.05) exitWith {hint "Dieses Fahrzeug ist zu beschädigt."}; //Dammaged vehicle.
	if (_vehicle in life_vehicles) exitWith {hint "Dieses Fahrzeug ist deines."}; //Own vehicle.
