...
if (_house isKindOf "House") then
{
	...
	{
		_isLocked = 0;
		hint format["Lagerraum und Schraenke von %1 wurden aufgeschlossen.", _buildingName];
	}
	else
	{
		_isLocked = 1;
		hint format["Lagerraum und Schraenke von %1 wurden abgeschlossen.", _buildingName];
	};
