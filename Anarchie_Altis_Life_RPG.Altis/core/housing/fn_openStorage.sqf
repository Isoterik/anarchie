...
if((_house getVariable ["trunk_in_use",false])) exitWith {hint "Der Lagerraum wird benutzt. Er kann nicht gleichzeitig benutzt werden."};
...
ctrlSetText[8501,format["Lagerraum - %1",getText(configFile >> "CfgVehicles" >> (typeOf _house) >> "displayName")]];
