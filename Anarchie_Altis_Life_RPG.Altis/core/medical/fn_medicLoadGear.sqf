/*
	...
	Description:
	Loads saved medic gear, this is limited for a reason and that's balance.
*/
private["_itemArray","_uniform","_backpack","_goggles","_headgear","_itemArray","_uItems","_bItems","_handle","_yItems"];
_itemArray = med_gear;

if(isNil "_itemArray") exitWith {[] call life_fnc_medicDefault;}; //Slot data doesn't exist
if(count _itemArray == 0) exitWith {[] call life_fnc_medicDefault;}; //Slot data doesn't exist
