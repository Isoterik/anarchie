...
if(_veh == "C_Van_01_fuel_F") then 
{
	_vehicle setFuelCargo 0
};

if(_veh == "O_Truck_02_fuel_F") then 
{
	_vehicle setFuelCargo 0
};

if(_veh == "O_Truck_03_fuel_F") then 
{
	_vehicle setFuelCargo 0
};

if(_veh == "B_Truck_01_fuel_F") then 
{
	_vehicle setFuelCargo 0
};

if(_veh == "O_Truck_03_ammo_F") then 
{
	_vehicle setAmmoCargo 0
};

if(_veh == "B_Truck_01_ammo_F") then 
{
	_vehicle setAmmoCargo 0
};

if(_veh == "O_Truck_03_repair_F") then 
{
	_vehicle setRepairCargo 0
};

if(_veh == "I_Truck_02_box_F") then 
{
	_vehicle setRepairCargo 0
};
