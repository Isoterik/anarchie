...
if(isNull life_trunk_vehicle OR !alive life_trunk_vehicle) exitWith {hint "Das Fahrzeug existiert nicht oder wurde Zerstoert."};
...
if(_num > _value) exitWith {hint "Es sind davon nicht so viele Items im Fahrzeug."};
	...
	else
{
	...
	{
		hint "Konnte dieses Item deinem Inventar nicht hinzufuegen. Ist dein Inventar voll?";
	};
};