...
if(_selection == -1) exitWith {hint "Nichts ausgewaehlt";};
...
_total ctrlSetStructuredText parseText format ["Gesammt: <t color='#8cff9b'>$%1</t>",[_totalPrice] call life_fnc_numberText];