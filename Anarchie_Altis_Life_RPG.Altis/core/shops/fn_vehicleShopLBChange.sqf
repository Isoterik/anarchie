...
"Leihgebuehr: <t color='#8cff9b'>$%1</t><br/>Kaufpreis: <t color='#8cff9b'>$%2</t><br/>V-Max: %3 km/h<br/>PS: %4<br/>Beifahrersitze: %5<br/>Ladekapazitaet: %6<br/>Tankvolumen: %7<br/>Panzerung: %8",
