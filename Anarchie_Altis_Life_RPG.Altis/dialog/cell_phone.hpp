class Life_cell_phone {
	...
	class controls {
		...
		class TextCopButton : life_RscButtonMenu 
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call fnc_cell_textcop; [[position player, profileName],""life_fnc_markVictim"",west,FALSE] call life_fnc_MP;";
		...
		class ADACRequest : life_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call fnc_cell_adacrequest; [[position player, profileName],""life_fnc_markVictim"",east,FALSE] call life_fnc_MP;";
